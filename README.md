...
- **native mode**: Ubuntu 20.04, 22.04 or 24.04 LTS (AMD64), an account with sudo.
- **docker mode**: a working docker + docker compose installation ([Docker documentation](https://docs.docker.com/engine/install/ubuntu/)), an account with sudo.
